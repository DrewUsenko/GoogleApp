...
//        request.setAttribute(ATTRIBUTE_FACULTY, request.getParameter(PARAMETER_FACULTY));
//        request.setAttribute(ATTRIBUTE_GROUP, request.getParameter(PARAMETER_GROUP));
//        request.setAttribute(ATTRIBUTE_SPECIALITY, request.getParameter(PARAMETER_SPESIALITY));
...
//        ROOT_PATH_SITE = this.getServletContext().getRealPath(File.separator) + "LiveEdu/";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute(ATTRIBUTE_COURSE_LIST, Student.getAllCources());
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private void tableFilter(HttpServletRequest request) throws NumberFormatException, HibernateException {
        ...
        if (strGroup != null && !strGroup.equals("")) {
            cr = cr.add(Restrictions.eq(DB_0.Persone.COLUM_GROUP, strGroup));
        }
